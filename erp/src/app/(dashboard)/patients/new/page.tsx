...
import { DOCUMENT_TYPES, Sex } from '@/types/patient';
    ...
    return (
        <div className="form-container">
            <header className="form-header">
                ...
                <p>Ingrese los datos para la apertura de la ficha cl├¡nica</p>
            </header>
            ...
            <form onSubmit={handleSubmit} className="patient-form glass-panel">
                ...
                <section className="form-section">
                    ...
                    <div className="form-grid">
                        <div className="field-group">
                            <label>EPS *</label>
                            <input name="eps" value={form.eps} onChange={handleChange} required placeholder="Ej: Sanitas, Sura..." />
                        </div>
                        <div className="field-group">
                            <label>R├©gimen *</label>
