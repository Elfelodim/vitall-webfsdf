...
export default function NewMachineScanPage() {
    ...
    const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            setForm(prev => ({ ...prev, rawOutputUrl: data.url }));
        } catch (err: any) {
        ...
        <div className="form-container">
            ...
            <form onSubmit={handleSubmit} className="clinical-form glass-panel">
                ...
                <div className="field-group file-upload-section">
                    <label>Archivo de Salida (Raw Data) *</label>
                    <div className="upload-controls">
                        <input type="file" onChange={handleFileUpload} disabled={uploading} />
                        {uploading && <span className="upload-status">Subiendo...</span>}
                        {form.rawOutputUrl && <span className="upload-success">✅ Archivo listo</span>}
                    </div>
                </div>
